...
const CAMPO_DESCRIPCION: Record<string, string> = {
  'home.hero.eyebrow':          '→ Home · Eyebrow del Hero ("Por qué aunque los tiempos cambien")',
  'home.hero.tagline':          '→ Home · Tagline principal del Hero (video)',
  'home.hero.sub':              '→ Home · Subtítulo bajo el tagline del Hero',
  'home.hero.video':            '→ Home · URL/Ruta del Video de Fondo (Hero)',
  'home.marcas_titulo':         '→ Home · Título sección "Las Marcas que nos Representan"',
  'home.marca1.logo':           '→ Home · Marcas · Logo 1 (Vizcaíno Fruit\'s)',
  'home.marca2.logo':           '→ Home · Marcas · Logo 2 (Vizcaíno Premium)',
  'home.marca3.logo':           '→ Home · Marcas · Logo 3 (Vizcaíno Services)',
  ...
  'home.noticias_titulo':       '→ Home · Título de la sección "Últimas Noticias"',
  'home.features_titulo':       '→ Home · Título de la sección "Conoce más de nosotros"',
  'home.clientes_eyebrow':      '→ Home · Clientes · Eyebrow / Copete ("NUESTROS CLIENTES")',
  'home.clientes_titulo':       '→ Home · Clientes · Título principal ("Empresas que confían en nosotros")',
  'home.eventos_eyebrow':       '→ Home · Eventos · Eyebrow / Copete ("AGENDA GEC")',
  'home.eventos_titulo':        '→ Home · Eventos · Título principal ("Próximos Eventos")',
  ...
  'quienes.hero.titulo':                  '→ Quiénes Somos · Título de la página (Hero)',
  'quienes.hero.sub':                     '→ Quiénes Somos · Subtítulo de la página (Hero)',
  ...
  'quienes.ceo.eyebrow':                  '→ Quiénes Somos · Eyebrow del Director General',
  'quienes.ceo.frase':                    '→ Quiénes Somos · Frase del Director General',
  'quienes.ceo.desc':                     '→ Quiénes Somos · Descripción del Director General',
  ...
  'quienes.intro.titulo':       '→ Quiénes Somos · Título "Grupo Exportador del Campo"',
  'quienes.intro.slogan':       '→ Quiénes Somos · Slogan "Somos y seremos GEC"',
  'quienes.esencia.eyebrow':     '→ Quiénes Somos · Nuestra Esencia · Eyebrow',
  'quienes.esencia.titulo':      '→ Quiénes Somos · Nuestra Esencia · Título',
  'quienes.esencia.subtitulo':   '→ Quiénes Somos · Nuestra Esencia · Subtítulo',
  'quienes.ecosistema.mision.titulo': '→ Quiénes Somos · Misión · Título de panel',
  'quienes.ecosistema.vision.titulo': '→ Quiénes Somos · Visión · Título de panel',
  'quienes.ecosistema.valores.titulo': '→ Quiénes Somos · Valores · Título de panel',
  ...
  'quienes.campo.paso1.titulo': '→ Quiénes Somos · Campo · Paso 1 · Título',
  'quienes.campo.paso1.desc':   '→ Quiénes Somos · Campo · Paso 1 · Descripción',
  'quienes.campo.paso1.sub1':   '→ Quiénes Somos · Campo · Paso 1 · Subproceso 1',
  'quienes.campo.paso1.sub2':   '→ Quiénes Somos · Campo · Paso 1 · Subproceso 2',
  'quienes.campo.paso1.sub3':   '→ Quiénes Somos · Campo · Paso 1 · Subproceso 3',
  'quienes.campo.paso1.sub4':   '→ Quiénes Somos · Campo · Paso 1 · Subproceso 4',
  'quienes.campo.paso2.titulo': '→ Quiénes Somos · Campo · Paso 2 · Título',
  'quienes.campo.paso2.desc':   '→ Quiénes Somos · Campo · Paso 2 · Descripción',
  'quienes.campo.paso2.sub1':   '→ Quiénes Somos · Campo · Paso 2 · Subproceso 1',
  'quienes.campo.paso2.sub2':   '→ Quiénes Somos · Campo · Paso 2 · Subproceso 2',
  'quienes.campo.paso2.sub3':   '→ Quiénes Somos · Campo · Paso 2 · Subproceso 3',
  'quienes.campo.paso2.sub4':   '→ Quiénes Somos · Campo · Paso 2 · Subproceso 4',
  'quienes.campo.paso3.titulo': '→ Quiénes Somos · Campo · Paso 3 · Título',
  'quienes.campo.paso3.desc':   '→ Quiénes Somos · Campo · Paso 3 · Descripción',
  'quienes.campo.paso3.sub1':   '→ Quiénes Somos · Campo · Paso 3 · Subproceso 1',
  'quienes.campo.paso3.sub2':   '→ Quiénes Somos · Campo · Paso 3 · Subproceso 2',
  'quienes.campo.paso3.sub3':   '→ Quiénes Somos · Campo · Paso 3 · Subproceso 3',
  'quienes.campo.paso3.sub4':   '→ Quiénes Somos · Campo · Paso 3 · Subproceso 4',
  'quienes.campo.paso4.titulo': '→ Quiénes Somos · Campo · Paso 4 · Título',
  'quienes.campo.paso4.desc':   '→ Quiénes Somos · Campo · Paso 4 · Descripción',
  'quienes.campo.paso4.sub1':   '→ Quiénes Somos · Campo · Paso 4 · Subproceso 1',
  'quienes.campo.paso4.sub2':   '→ Quiénes Somos · Campo · Paso 4 · Subproceso 2',
  'quienes.campo.paso4.sub3':   '→ Quiénes Somos · Campo · Paso 4 · Subproceso 3',
  'quienes.campo.paso4.sub4':   '→ Quiénes Somos · Campo · Paso 4 · Subproceso 4',
  'quienes.cedis.paso1.titulo': '→ Quiénes Somos · CEDIS · Paso 1 · Título',
  'quienes.cedis.paso1.desc':   '→ Quiénes Somos · CEDIS · Paso 1 · Descripción',
  'quienes.cedis.paso2.titulo': '→ Quiénes Somos · CEDIS · Paso 2 · Título',
  'quienes.cedis.paso2.desc':   '→ Quiénes Somos · CEDIS · Paso 2 · Descripción',
  'quienes.cedis.paso3.titulo': '→ Quiénes Somos · CEDIS · Paso 3 · Título',
  'quienes.cedis.paso3.desc':   '→ Quiénes Somos · CEDIS · Paso 3 · Descripción',
  'quienes.cedis.paso4.titulo': '→ Quiénes Somos · CEDIS · Paso 4 · Título',
  'quienes.cedis.paso4.desc':   '→ Quiénes Somos · CEDIS · Paso 4 · Descripción',
  'quienes.campo.paso1.imagen': '→ Quiénes Somos · Campo · Paso 1 · Imagen',
  'quienes.campo.paso2.imagen': '→ Quiénes Somos · Campo · Paso 2 · Imagen',
  'quienes.campo.paso3.imagen': '→ Quiénes Somos · Campo · Paso 3 · Imagen',
  'quienes.campo.paso4.imagen': '→ Quiénes Somos · Campo · Paso 4 · Imagen',
  ...
  'quienes.primus.eyebrow':      '→ Quiénes Somos · Primus GFS · Eyebrow',
  'quienes.primus.titulo':       '→ Quiénes Somos · Primus GFS · Título',
  'quienes.primus.desc':         '→ Quiénes Somos · Primus GFS · Descripción',
  'quienes.primus.imagen':       '→ Quiénes Somos · Primus GFS · Logo / Badge',
  'quienes.capital.eyebrow':    '→ Quiénes Somos · Capital Humano · Eyebrow',
  'quienes.capital.foto1':      '→ Quiénes Somos · Capital Humano · Foto Mosaico 1 (Arriba Izquierda)',
  'quienes.capital.foto2':      '→ Quiénes Somos · Capital Humano · Foto Mosaico 2 (Arriba Derecha)',
  'quienes.capital.foto3':      '→ Quiénes Somos · Capital Humano · Foto Mosaico 3 (Abajo Izquierda)',
  'quienes.capital.foto4':      '→ Quiénes Somos · Capital Humano · Foto Mosaico 4 (Abajo Derecha)',
  'quienes.capital.titulo':     '→ Quiénes Somos · Capital Humano · Título principal',
  'quienes.capital.quote':      '→ Quiénes Somos · Capital Humano · Cita inspiracional',
  'quienes.capital.stat1.numero': '→ Quiénes Somos · Capital Humano · Número de Métrica 1',
  'quienes.capital.stat1.label':  '→ Quiénes Somos · Capital Humano · Etiqueta de Métrica 1',
  'quienes.capital.stat2.numero': '→ Quiénes Somos · Capital Humano · Número de Métrica 2',
  'quienes.capital.stat2.label':  '→ Quiénes Somos · Capital Humano · Etiqueta de Métrica 2',
  'quienes.capital.stat3.numero': '→ Quiénes Somos · Capital Humano · Número de Métrica 3',
  'quienes.capital.stat3.label':  '→ Quiénes Somos · Capital Humano · Etiqueta de Métrica 3',
  'quienes.capital.stat4.numero': '→ Quiénes Somos · Capital Humano · Número de Métrica 4',
  'quienes.capital.stat4.label':  '→ Quiénes Somos · Capital Humano · Etiqueta de Métrica 4',
  'quienes.ecosistema.gec.eyebrow': '→ Quiénes Somos · Ecosistema GEC · Eyebrow',
  'quienes.ecosistema.gec.titulo':  '→ Quiénes Somos · Ecosistema GEC · Título',
  'quienes.ecosistema.gec.slogan':  '→ Quiénes Somos · Ecosistema GEC · Slogan final',
  'quienes.ecosistema.gec.pilar1.titulo': '→ Quiénes Somos · Ecosistema GEC · Pilar 1 · Título',
  'quienes.ecosistema.gec.pilar1.subtitulo': '→ Quiénes Somos · Ecosistema GEC · Pilar 1 · Subtítulo',
  'quienes.ecosistema.gec.pilar1.desc': '→ Quiénes Somos · Ecosistema GEC · Pilar 1 · Descripción',
  'quienes.ecosistema.gec.pilar2.titulo': '→ Quiénes Somos · Ecosistema GEC · Pilar 2 · Título',
  'quienes.ecosistema.gec.pilar2.subtitulo': '→ Quiénes Somos · Ecosistema GEC · Pilar 2 · Subtítulo',
  'quienes.ecosistema.gec.pilar2.desc': '→ Quiénes Somos · Ecosistema GEC · Pilar 2 · Descripción',
  'quienes.ecosistema.gec.pilar3.titulo': '→ Quiénes Somos · Ecosistema GEC · Pilar 3 · Título',
  'quienes.ecosistema.gec.pilar3.subtitulo': '→ Quiénes Somos · Ecosistema GEC · Pilar 3 · Subtítulo',
  'quienes.ecosistema.gec.pilar3.desc': '→ Quiénes Somos · Ecosistema GEC · Pilar 3 · Descripción',
  'quienes.ecosistema.gec.pilar4.titulo': '→ Quiénes Somos · Ecosistema GEC · Pilar 4 · Título',
  'quienes.ecosistema.gec.pilar4.subtitulo': '→ Quiénes Somos · Ecosistema GEC · Pilar 4 · Subtítulo',
  'quienes.ecosistema.gec.pilar4.desc': '→ Quiénes Somos · Ecosistema GEC · Pilar 4 · Descripción',
  'historia.hero.titulo':       '→ Historia · Título del banner superior (Hero)',
  'historia.hero.sub':          '→ Historia · Subtítulo del banner superior (Hero)',
  ...
  'timeline.titulo':            '→ Historia · Línea de Tiempo · Título Principal',
  'historia.fundadores.caption': '→ Historia · Fundadores · Leyenda de la foto (Nombres)',
  ...
  'holding.marca1.nombre':      '→ Holding · Marca 1 · Nombre (ej: Vizcaíno Fruits)',
  'holding.marca1.subtitulo':   '→ Holding · Marca 1 · Subtítulo / Frase interna',
  'holding.marca1.texto':       '→ Holding · Marca 1 · Descripción corta',
  'holding.marca1.pie':         '→ Holding · Marca 1 · Acción/Pie de tarjeta (ej: Cultivamos)',
  'holding.marca1.imagen':      '→ Holding · Marca 1 · Imagen de Fondo de Tarjeta',
  'holding.marca1.logo':        '→ Holding · Marca 1 · Logotipo',
  
  'holding.marca2.nombre':      '→ Holding · Marca 2 · Nombre (ej: Vizcaíno Premium)',
  'holding.marca2.subtitulo':   '→ Holding · Marca 2 · Subtítulo / Frase interna',
  'holding.marca2.texto':       '→ Holding · Marca 2 · Descripción corta',
  'holding.marca2.pie':         '→ Holding · Marca 2 · Acción/Pie de tarjeta (ej: Transformamos)',
  'holding.marca2.imagen':      '→ Holding · Marca 2 · Imagen de Fondo de Tarjeta',
  'holding.marca2.logo':        '→ Holding · Marca 2 · Logotipo',

  'holding.marca3.nombre':      '→ Holding · Marca 3 · Nombre (ej: Vizcaíno Services)',
  'holding.marca3.subtitulo':   '→ Holding · Marca 3 · Subtítulo / Frase interna',
  'holding.marca3.texto':       '→ Holding · Marca 3 · Descripción corta',
  'holding.marca3.pie':         '→ Holding · Marca 3 · Acción/Pie de tarjeta (ej: Movemos)',
  ...
  'footer.direccion.tijuana':   '→ Global · Footer · Dirección Tijuana',
  'footer.telefono':            '→ Global · Footer · Teléfono de Contacto',
  'footer.correo':              '→ Global · Footer · Correo de Contacto',
  'footer.copyright':           '→ Global · Footer · Texto de Copyright',
  'footer.privacidad':          '→ Global · Footer · Texto del Enlace de Privacidad',
  'footer.terminos':            '→ Global · Footer · Texto del Enlace de Términos',
};
